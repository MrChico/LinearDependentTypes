...
\begin{defn}\label{semanticML}
  A model of LDTT \textbf{supports the operators $M$ and $L$} if there exists monoidal functors $M : \mathcal{L}_{\Gamma} \leftrightarrow \mathcal{T}_{\Gamma} : L$ over every fiber $\Gamma$ such that $L$ is monoidal left adjoint to $M$.
\end{defn}
